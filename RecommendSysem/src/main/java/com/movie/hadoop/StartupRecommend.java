...
public class StartupRecommend {
	...
	public static void startupRecommend(Integer uId, String hadoopUrl,String step1InputPath,String step2InputPath,String step1OutputPath,String step2OutputPath,String step3OutputPath) throws Exception {
		...
		// 启动推荐算法
		MR1.step1(uId,hadoopUrl,step1InputPath+"/",step1OutputPath+"_"+uId,"RecommendResult_"+uId+"_temp1");
		
		MR2.step2(uId,hadoopUrl,step2InputPath+"/",step2OutputPath+"_"+uId,"RecommendResult_"+uId+"_temp2",step1OutputPath+"_"+uId+"/RecommendResult_"+uId+"_temp1-r-00000");
		
		MR3.step3(uId,hadoopUrl,step1InputPath+"/",step3OutputPath+"_"+uId,"RecommendResult_"+uId,step2OutputPath+"_"+uId+"/RecommendResult_"+uId+"_temp2-r-00000");
